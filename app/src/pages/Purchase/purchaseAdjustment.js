...
export default function PurchaseAdjustment() {
    ...
    const [form3InitialValues, setForm3Values] = useState({
        ...
        Amount1: { value: '', type: 'number', readonly: false },
    ...
    return (
        <>
            <div className='flex flex-col w-screen h-full p-6'>
                {/* section-0 */}
                <div className='border-2 border-black p-5 rounded-xl justify-center items-center'>
                    <div className='grid grid-cols-2 gap-2'>
                        <FormItems form={form1InitialValues} setForm={setForm1Values} width={96} />
                    </div>
                </div>
                ...
                <div className='border-2 border-black p-5 rounded-xl justify-center items-center mt-2'>
                    <div className='grid grid-cols-2 gap-2'>
                        <FormItems form={form2InitialValues} setForm={setForm2Values} width={96} />
                    </div>
                </div>
                ...
                <div className='border-2 border-black p-5 rounded-xl mt-3 justify-center items-center'>
                    <div className='grid grid-cols-2 gap-2'>
                        <FormItems form={form3InitialValues} setForm={setForm3Values} width={96} />
                    </div>
                </div>
                {/* end of section 2 */}
                ...
                <div className='border-2 border-black p-5 rounded-xl mt-3 justify-center items-center'>
                    ...
                    <div className='grid grid-cols-3 gap-2'>
                        <FormItems form={form4InitialValues} setForm={setForm4Values} width={18} />
                    </div>
                </div>
                ...
                <div className='border-2 border-black p-5 rounded-xl mt-3 justify-center items-center'>
                    ...
                    <div className='grid grid-cols-3 gap-2'>
                        <FormItems form={form5InitialValues} setForm={setForm5Values} width={18} />
                    </div>
                </div>
